...
{
    public partial class Section4Part2 : System.Web.UI.Page
    {
        ...
        {
            /**
             * Load the Level2 questions for Section 4 Part 2 "Opt Ins/Outs"
        ...
        private void SaveAnswers(DataTable dt)
        {
            ...
            SetDeafaults(dt, userId, "Privacy Policy", 4);
        }
