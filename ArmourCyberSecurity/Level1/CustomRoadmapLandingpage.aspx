<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomRoadmapLandingpage.aspx.cs" Inherits="ArmourCyberSecurity.CustomRoadmapLandingpage" %>
...
<head runat="server">
  ...
  <meta name="description" content="Questionnaire(level_2 homepage)" />
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href="#progress-bars3-o">PROGRESS</a></li><li class="nav-item"><a class="nav-link link text-white display-4" href="#info2-s">REPORT</a></li></ul>
            
        </div>
    </nav>
</section>

<section class="engine"><a href="#">Info</a></section><section class="header9 cid-rWXmw24scK mbr-fullscreen">

    

    <div class="mbr-overlay" style="opacity: 0.4; background-color: rgb(70, 70, 70);">
    </div>

    <form id="form1" class="container" runat="server">
        <div class="media-container-column mbr-white col-lg-8 col-md-10 m-auto">
            <h1 class="mbr-section-title align-left mbr-bold pb-3 mbr-fonts-style display-1" style="color: white">WELCOME&nbsp;</h1>
            <h3 class="mbr-section-subtitle align-left mbr-light pb-3 mbr-fonts-style display-2"style="color: white">Heading of the text</h3>
            <p class="mbr-text align-left pb-3 mbr-fonts-style display-5" style="color: white">
            ...
            <div class="mbr-section-btn align-left"><a class="btn btn-md btn-primary display-4" href="#toggle1-q">HOW IT WORKS</a>
                <asp:Button ID="btn_questionnaire" runat="server" CssClass="btn btn-md btn-white-outline display-4" Text="TAKE ME TO QUESTIONNAIRE" OnClick="btn_questionnaire_Click" />
                </div>
        </div>
    </form>
...
<section class="toggle1 cid-rWXpFnCiHu" id="toggle1-q">
            ...
            <div class="media-container-row">
                <div class="col-12 col-md-8">
                    ...
                    <div class="section-head text-center space30">
                       <h2 class="mbr-section-title pb-5 mbr-fonts-style display-2">HELP &amp; FAQ
                        </h2>
                    </div>
                    <div class="clearfix"></div>
                    <div id="bootstrap-toggle" class="toggle-panel accordionStyles tab-content">
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne" style="background-color: #149dcc">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse1_21" aria-expanded="false" aria-controls="collapse1">
                                    <h4 class="mbr-fonts-style display-5" style="color: white">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;This is a accordion Title 1</h4>
                                </a>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingTwo" style="background-color: #ffffff">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse2_21" aria-expanded="false" aria-controls="collapse2">
                                    <h4 class="mbr-fonts-style display-5"style="color: #149dcc">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;This is a accordion Title 2</h4>
                                </a>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree" style="background-color: #149dcc">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse3_21" aria-expanded="false" aria-controls="collapse3">
                                    <h4 class="mbr-fonts-style display-5"style="color: #ffffff">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;This is a accordion Title 3</h4>
                                </a>
                            </div>
...
<!--                                       Key differences from traditional builders:<br />* Minimalistic, extremely <strong>easy-to-use</strong> interface<br />* <strong>Mobile</strong>-friendliness, latest website blocks and techniques "out-the-box"<br />* <strong>Free</strong> for commercial and non-profit use-->
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree"style="background-color: #ffffff">
                            ...
                            <div id="collapse4_21" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree" style="background-color: #149dcc">
                                <div class="panel-body p-4"style="background-color:white">
                                    <p class="mbr-fonts-style panel-text display-7">
                                       Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur in nulla ut magna vehicula libero luctus in ipsum consequat faucibus. Ut porta nulla ac dapibus convallis. Curabitur sit amet massa quam. In ut ex auctor, porta neque quis, sagittis purus. Nunc auctor gravida magna, sed efficitur tortor tristique quis.</p>
                                </div>
