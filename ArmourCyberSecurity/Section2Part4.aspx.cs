...
{
    public partial class Section2Part4 : System.Web.UI.Page
    {
        ...
        {
            /**
             * Load the Level2 questions for Section 2 Part 4 "Privacy Impact Assessment"
        ...
        private void SaveAnswers(DataTable dt)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                if (row["question_type"].ToString() == "Privacy Impact Assessment" && row["section"].ToString() == "2")
                {
