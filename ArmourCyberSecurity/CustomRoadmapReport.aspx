<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/main.Master" CodeBehind="CustomRoadmapReport.aspx.cs" Inherits="ArmourCyberSecurity.CustomRoadmapReport" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">


    <asp:Label ID="lbl_userinit" runat="server" Style="display: none !important;" Text="" CssClass="nav-link link text-white display-4" ForeColor="#0795d6" />

    <div class="card shadow h-100">
        <div class="card-body">
            <section class="text-center">
                <div class="container">
                    <h3>Global Data Privacy Regulation Compliance 
                                Custom Roadmap - Report
                    </h3>
                    <p>
                        Your clients’ data is your greatest asset. If the data is breached you will lose money, time, and credibility. Breaches can be avoided with good cyber 
                security practices and compliance with regulations. Companies are legally required to fulfill the privacy regulations determined by the geographical location 
                of both the company and their customers/clients. Compliance is a large task, but when done properly the first time, it becomes simple to maintain. 
                Doing due diligence helps mitigate risk to customers, protects a company’s reputation, and drastically reduces fines.
                    </p>
                </div>
            </section>
        </div>
    ...
    <div class="card shadow h-100">
        ...
        <div class="card-body">
            <%--Global Regulations--%>
            <div id="divGlobalRegulations" runat="server">
                <h5 class="card-header">Global Regulations</h5>
                <br />
                <div class="container">
                    ...
                    <p>
                        The Global Regulations report deals with the region in which you do business; This includes both where your office resides and where your customers reside.
                                <br />
                        For the purpose of this report, we will be focusing on <strong>GDPR</strong> (Europe), <strong>PIPEDA</strong> (Canada),<strong> CCPA</strong>
                        (California), and <strong>LGPD</strong> (Brazil). This said, between the global reach of many 
                            companies and the fact that more countries and regional oversight are coming to law, following the best practice 
                            suggestions laid out in all the sections of this report will benefit you regardless of region.
                    </p>
                    ...
                    <p>
                        ...
                        They are typical labeled  <strong>Health Insurance Portability and Accountability Act</strong> (HIPPA), or the like.
                    </p>
            ...
            <%--Privacy Engineering--%>
            <div id="divPrivacyEngineering" runat="server">
                <h5 class="card-header">PRIVACY ENGINEERNG & DATA ANALYSIS </h5>
                <br />
                <div class="container">
...
Of all the elements of compliance,<b> a thorough DPIA will take the most amount of time</b>. Authorities suggest reviewing the DPIA every 6 months. When done properly the first time, the review should have a minimal impact on resources going forward. A new DPIA should be done for every new system or service created if it involves PII.
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_sm_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_dm_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_dpia_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_pidap_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_duisit_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_duisEt_links" runat="server" Text="" />
                        </p>
                    </div>
                    ...
                    <div class="jumbotron">
                        <p>
                            <asp:Label ID="lbl_vmp_links" runat="server" Text="" />
                        </p>
                    </div>
            ...
            <div class="boxshadow zoom" id="divDataControl" runat="server">
                ...
                <div class="card-header">DATA CONTROL </div>
...
Review the items below to ensure that you have covered all of your bases. 
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_dsarp" runat="server" Text="" />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_drdp" runat="server" Text="" />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_drsc" runat="server" Text="" />
                    </p>
                </div>
            </div>
            <%--Data Control--%>
            ...
            <div class="boxshadow zoom" id="divIncidentManagement" runat="server">
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_im_pbl" runat="server" Text="" />
                        <br />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_im_irp" runat="server" Text="" />
                        <br />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_dpant" runat="server" Text="" />
                        <br />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_im_int" runat="server" Text="" />
                        <br />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_im_ent" runat="server" Text="" />
                        <br />
                    </p>
                </div>
...
To meet compliance, you need only to have evidence of a program. To prevent breaches, (accidental) insider threats, and reputation protection, we suggest you have all the pieces below implemented. The small amount of effort upfront will lower your risks and costs significantly.
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_onet" runat="server" Text="" />
                    </p>
                </div>
                ...
                <div class="jumbotron">
                    <p>
                        <asp:Label ID="lbl_pct" runat="server" Text="" />
                    </p>
                </div>
